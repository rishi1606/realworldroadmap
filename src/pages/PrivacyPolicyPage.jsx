          ...
          <section className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-3">
                ...
                <li>
                  <strong className="text-text-main">Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to TechPaths.
                </li>
                <li>
                ...
                <li>
                  <strong className="text-text-main">Website</strong> refers to TechPaths, accessible from this domain.
                </li>
                <li>
